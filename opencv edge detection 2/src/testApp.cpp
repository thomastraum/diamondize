...
void testApp::setup(){
    ...
    int cv_width = img.width;
    int cv_height = img.height;
    
    colorImg.allocate(cv_width,cv_height);
	grayImage.allocate(cv_width,cv_height);
	grayBg.allocate(cv_width,cv_height);
	grayDiff.allocate(cv_width,cv_height);
    
    thresh_resized.allocate(cv_width,cv_height);
    thresh_resized_width    = 800;
    thresh_resized_height   = 600;
    
    tempFrame.allocate(cv_width,cv_height);
	...
	gui.addSlider( "low_threshold", low_threshold, 0, 255 );
    gui.addSlider( "high_threshold", high_threshold, 0, 255 );
